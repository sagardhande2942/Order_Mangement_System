...
public class Dashboard extends javax.swing.JFrame {
    ...
    public static void updateTrack(Connection c,Integer id, String name, Integer stock, Integer price, Integer del)
    {
        Statement s = null;
        ResultSet rs = null;
        String sql = "insert into trans (id, name1, quan, price, delivery) values(";
        sql += id + " ,\'" + name + "\', " + stock.toString() + " ," + price.toString() + ", " + del.toString() + " );";
...
//        ResultSet rs1 = null, rs2 = null;
    ...
    private void initComponents() {
        ...
        RefreshTrack.setFont(new java.awt.Font("Tahoma", 1, 9)); // NOI18N
        ...
        jTextArea1.setMinimumSize(new java.awt.Dimension(304, 109));
        jTextArea1.setPreferredSize(new java.awt.Dimension(304, 109));
