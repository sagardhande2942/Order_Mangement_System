...
//        ResultSet rs1 = null, rs2 = null;
    ...
    private void initComponents() {
        ...
        clearTrack = new javax.swing.JButton();
        ...
        tracktext.setRows(5);
        tracktext.setText("Trans_ID\tName\tQuantity\tPrice\tDelivery\n");
        jScrollPane1.setViewportView(tracktext);

        clearTrack.setBackground(new java.awt.Color(0, 51, 255));
        clearTrack.setForeground(new java.awt.Color(255, 255, 255));
        clearTrack.setText("Clear Track");
        clearTrack.setContentAreaFilled(false);
        clearTrack.setOpaque(true);
        clearTrack.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                clearTrackActionPerformed(evt);
            }
        });
        ...
        trackPageLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, trackPageLayout.createSequentialGroup()
                ...
                .addGroup(trackPageLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(trackPageLayout.createSequentialGroup()
                        .addComponent(jScrollPane1)
                        .addGap(18, 18, 18)
                        .addComponent(clearTrack, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        trackPageLayout.setVerticalGroup(
            ...
            .addGroup(trackPageLayout.createSequentialGroup()
                ...
                .addGroup(trackPageLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(trackPageLayout.createSequentialGroup()
                        .addGap(98, 98, 98)
                        .addComponent(clearTrack, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
...
//        }
    ...
    private void buy1butActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buy1butActionPerformed
        ...
        if(i3 < 0 || i1 < 0)
        {
            ...
            String sg = ss + "\n" + transid.toString() + "\tJeans " + "\t" + but1.toString() + "\t" + Integer.parseInt(price1.getText()) * but1 + "\t" + generateRandom() + " Days\n";
    ...
    private void buy2butActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buy2butActionPerformed
        ...
        if(i3 < 0 || i1 < 0)
        {
            ...
            String sg = ss + "\n" + transid + "\tTshirt " + "\t" + but2.toString() + "\t" + Integer.parseInt(price2.getText()) * but2 + "\t" + generateRandom() + " Days\n";
            tracktext.setText(sg);
        }
        }
             String sq = "Select * from balance";
    ...
    private void buy3butActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buy3butActionPerformed
        ...
        if(i3 < 0 || i1 < 0)
        {
            ...
            String sg = ss + "\n" + transid + "\tShirt " + "\t" + but3.toString() + "\t" + Integer.parseInt(price3.getText()) * but3 + "\t" + generateRandom() + " Days\n";
            tracktext.setText(sg);
        }
        }
    ...
    private void buy4butActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buy4butActionPerformed
        ...
        if(i3 < 0 || i1 < 0)
        {
            ...
            String sg = ss + "\n" + transid + "\tJacket " + "\t" + but4.toString() + "\t" + Integer.parseInt(price4.getText()) * but4 + "\t" + generateRandom() + " Days\n";
            tracktext.setText(sg);
        }
        }
    ...
    private void buy5butActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buy5butActionPerformed
        ...
        if(i3 < 0 || i1 < 0)
        {
            ...
            String sg = ss + "\n" + transid + "\tHoodie " + "\t" + but5.toString() + "\t" + Integer.parseInt(price5.getText()) * but5 + "\t" + generateRandom() + " Days\n";
            tracktext.setText(sg);
        }
        }
             String sq = "Select * from balance";
    ...
    private void buy6butActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buy6butActionPerformed
        ...
        if(i3 < 0 || i1 < 0)
        {
            ...
            String sg = ss + "\n" +transid + "\tSweater " + "\t" + but6.toString() + "\t" + Integer.parseInt(price6.getText()) * but6 + "\t" + generateRandom() + " Days\n";
            tracktext.setText(sg);
        }
        }
    ...
    private void clearTrackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearTrackActionPerformed
        // TODO add your handling code here:
        tracktext.setText("Name\tQuantity\tPrice\tDelivery\n");
    }//GEN-LAST:event_clearTrackActionPerformed
    ...
    private javax.swing.JButton clearTrack;
    ...
    private javax.swing.JTextArea tracktext;
