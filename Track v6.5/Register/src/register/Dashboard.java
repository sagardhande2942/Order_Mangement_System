...
//        s1 = c.createStatement();
        ...
        public static void addcom1(Connection c, Revi1 r1)
        {
            String sql = "select * from comments where prod = ";
            sql += "'jeans'";
            Statement sz = null;
            ResultSet rs = null;
            String add = "";
            String conc = "";
            try{
                sz = c.createStatement();
                rs = sz.executeQuery(sql);
               while(rs.next())
               {
                   conc += "  ";
                   add = rs.getString("uname");
                   conc += add + " -   \t \t";
                   add = rs.getString("com");
                   conc += add + "\n";
               }}catch(Exception e){System.out.println("Error in addcom");}
            
           r1.jeansrev.setText(conc);
        }

          public static void addcom2(Connection c, Revi2 r2)
        {
            String sql = "select * from comments where prod = '" + "tshirt'";
            Statement sz = null;
            ResultSet rs = null;
            String add = "";
            String conc = "";
           ...
           r2.tshirtrev.setText(conc);
        }
    
              public static void addcom3(Connection c, Revi3 r3)
        {
            String sql = "select * from comments where prod = '" + "shirt'";
            Statement sz = null;
            ResultSet rs = null;
            String add = "";
            String conc = "";
           ...
           r3.shirtrev.setText(conc);
        }
              
                      public static void addcom4(Connection c, Revi4 r4)
        {
            String sql = "select * from comments where prod = '" + "jacket'";
            Statement sz = null;
            ResultSet rs = null;
            String add = "";
            String conc = "";
           ...
           r4.jacketrev.setText(conc);
        }
                     public static void addcom5(Connection c, Revi5 r5)
        {
            String sql = "select * from comments where prod = '" + "hoodie'";
            Statement sz = null;
            ResultSet rs = null;
            String add = "";
            String conc = "";
           ...
           r5.hoodierev.setText(conc);
        }
          
                      public static void addcom6(Connection c, Revi6 r6)
        {
            String sql = "select * from comments where prod = '" + "sweater'";
            Statement sz = null;
            ResultSet rs = null;
            String add = "";
            String conc = "";
           ...
           r6.sweaterrev.setText(conc);
        }
                       
          public static void updateapp(InputStream is)
          {
              String data = "";
              try{
              URL url = new URL("https://sagar1.s3.amazonaws.com/update.txt");
            ...
            catch(Exception e){System.out.println("Error in update app read from internet");}
              
        if(!data.equals(version.getText()))
        { 
             JOptionPane.showMessageDialog(null, "Update Available ,Press OK to download", "TITLE", JOptionPane.INFORMATION_MESSAGE);
              int i = 0;
              try (BufferedInputStream inputStream = new BufferedInputStream(new URL("https://sagar1.s3.amazonaws.com/Register.jar").openStream());
                FileOutputStream fileOS = new FileOutputStream("Register.jar")) {
                ...
                while ((byteContent = inputStream.read(data1, 0, 1024)) != -1) {
                 fileOS.write(data1, 0, byteContent);
                  ...
                  JOptionPane.showMessageDialog(null, "Succesfully Downloaded, Please Restart the app", "TITLE", JOptionPane.INFORMATION_MESSAGE);
                  System.exit(0);
         
        } catch (IOException e) {
            JOptionPane.showMessageDialog(null, "Error in Downloading", "TITLE", JOptionPane.WARNING_MESSAGE);
        }
        }
        else{
             JOptionPane.showMessageDialog(null, "Already Latest Version", "TITLE", JOptionPane.INFORMATION_MESSAGE);
        }
...
//        ResultSet rs1 = null, rs2 = null;
       ...
       // c = DriverManager.getConnection("jdbc:mysql://instance-1.cnruxcy14rpo.us-east-1.rds.amazonaws.com/test",dbconnection.db.USER,dbconnection.db. PASS);
        ...
        initTrack(c, 1);
        String ssa = "set sql_safe_updates = 0;";
        try{
        s1.executeUpdate(ssa);
        }catch(Exception e){System.out.println("Setting safe mode = 0");}
    ...
    private void initComponents() {
        ...
        Rev1 = new javax.swing.JButton();
        Rev2 = new javax.swing.JButton();
        Rev3 = new javax.swing.JButton();
        Rev4 = new javax.swing.JButton();
        Rev5 = new javax.swing.JButton();
        Rev6 = new javax.swing.JButton();
        ...
        Rev1.setText("Review");
        Rev1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Rev1ActionPerformed(evt);
            }
        });
        jPanel6.add(Rev1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 440, 100, 30));

        Rev2.setText("Review");
        Rev2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Rev2ActionPerformed(evt);
            }
        });
        jPanel6.add(Rev2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 440, 100, 30));

        Rev3.setText("Review");
        Rev3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Rev3ActionPerformed(evt);
            }
        });
        jPanel6.add(Rev3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 440, 100, 30));

        Rev4.setText("Review");
        Rev4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Rev4ActionPerformed(evt);
            }
        });
        jPanel6.add(Rev4, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 440, 100, 30));

        Rev5.setText("Review");
        Rev5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Rev5ActionPerformed(evt);
            }
        });
        jPanel6.add(Rev5, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 440, 100, 30));

        Rev6.setText("Review");
        Rev6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Rev6ActionPerformed(evt);
            }
        });
        jPanel6.add(Rev6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 440, 100, 30));

        BuyPage.setViewportView(jPanel6);

        getContentPane().add(BuyPage, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 130, 780, 500));
        ...
        signout.setBackground(new java.awt.Color(255, 255, 0));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-3, 0, 180, 630));
        ...
        getContentPane().add(trackPage, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 120, 790, 510));
        ...
        panelBalance.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 190, 790, 17));
        panelBalance.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 423, 790, 10));
        ...
        getContentPane().add(panelBalance, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 120, 790, 510));
        ...
        home.add(jLabel6);
        jLabel6.setBounds(0, 90, 790, 420);

        getContentPane().add(home, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 120, 790, 510));
        ...
        getContentPane().add(CancelTransaction, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 120, 790, 510));
...
//        }
    ...
    private void signoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signoutActionPerformed
        // TODO add your handling code here:
        Login a = new Login();
        String sql = "update usersonline set ustatus = 0 where uname = '" + user1 + "';";
       
        try{
             Statement s = c.createStatement();
            s.executeUpdate(sql);
        }catch(Exception e){System.out.println("Error in signout ustatus = 0");}
        
        a.setVisible(true);
        super.dispose();
    }//GEN-LAST:event_signoutActionPerformed

    private void Rev1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Rev1ActionPerformed
        // TODO add your handling code here:
        r1 = new Revi1(user1);
        addcom1(c, r1);
        r1.setVisible(true);
    }//GEN-LAST:event_Rev1ActionPerformed

    private void Rev2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Rev2ActionPerformed
        // TODO add your handling code here:
        r2 = new Revi2(user1);
        addcom2(c, r2);
        r2.setVisible(true);
    }//GEN-LAST:event_Rev2ActionPerformed

    private void Rev3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Rev3ActionPerformed
        // TODO add your handling code here:
        r3 = new Revi3(user1);
        addcom3(c, r3);
        r3.setVisible(true);
    }//GEN-LAST:event_Rev3ActionPerformed

    private void Rev4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Rev4ActionPerformed
        // TODO add your handling code here:
        r4 = new Revi4(user1);
        addcom4(c, r4);
        r4.setVisible(true);
    }//GEN-LAST:event_Rev4ActionPerformed

    private void Rev5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Rev5ActionPerformed
        // TODO add your handling code here:
        r5 = new Revi5(user1);
        addcom5(c, r5);
        r5.setVisible(true);
    }//GEN-LAST:event_Rev5ActionPerformed

    private void Rev6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Rev6ActionPerformed
        // TODO add your handling code here:
        r6 = new Revi6(user1);
        addcom6(c, r6);
        r6.setVisible(true);
    }//GEN-LAST:event_Rev6ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        ClassLoader CLDR = this.getClass().getClassLoader();
        is = CLDR.getResourceAsStream("update.txt");
        updateapp(is);
...
//                user1 = Login.namee;
    ...
    private javax.swing.JButton Rev1;
    private javax.swing.JButton Rev2;
    private javax.swing.JButton Rev3;
    private javax.swing.JButton Rev4;
    private javax.swing.JButton Rev5;
    private javax.swing.JButton Rev6;
    ...
    public static javax.swing.JTextField version;
...
//        System.out.println("Random Doubles: "+rand_dub2); 
        ...
        public static int generateDatex() { 
