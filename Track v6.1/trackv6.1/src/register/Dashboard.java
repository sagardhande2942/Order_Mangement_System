...
public class Dashboard extends javax.swing.JFrame {
    ...
    public static void initTrack(Connection c, Integer id)
    {
        ResultSet rs = null;
        Statement s = null;
        String sql = "select id, name1, quan, price, delivery from trans";
        Integer ii = 0;
        String name = "";
        Integer quan = 0;
        Integer price = 0;
        ...
        String so = "select id,status1, purchase, deliver from trans";
        String status = "";
        String purch = "";
        String dela = "";
        Integer ad = 0;
    ...
    public static void updateTrack(Connection c,Integer id, String name, Integer stock, Integer price, Integer del)
    {
        ...
        sql += id + " ,\'" + name + "\', " + stock.toString() + " ," + price.toString() + ", " + del.toString() + ",\"" + status + "\",'" + currreal + "', '" + realdel  +  "' );";
...
//        }
    ...
    private void buy1butActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buy1butActionPerformed
        ...
        if(i3 < 0 || i1 < 0)
        {
            ...
            updateTrack(c, transidreal,"Jeans", i2 , b * i2, ran);
             initTrack(c, 1);     JOptionPane.showMessageDialog(null, "Purchase Succesful", "TITLE", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        s1 += a.toString();
        int flag = 0;
        String s2 = "select id from trans";
        Statement s = null;
        Integer tid = 0;
        ResultSet rs = null;
        try{
